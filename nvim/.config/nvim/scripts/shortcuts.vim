" Shortcuts with a comma for fast writing
"""LATEX
	" Word count:
...
"""HTML
	...
	autocmd FileType html inoremap ,e <a<Space>targe="_blank"<Space>href=""><++></a><Space><++><Esc>14hi
...
"MARKDOWN
	...
	autocmd Filetype markdown,rmd inoremap ,j ```{julia}<CR>```<CR><CR><esc>2kO
	autocmd Filetype markdown,rmd inoremap ,c ```<cr>```<cr><cr><esc>2kOt
